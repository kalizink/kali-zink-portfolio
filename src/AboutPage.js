			...
			<section>
				<div className="row">
					<div className="column mt-5">
						...
						<p className="mt-4">
							{`Eager and driven React developer proficient in HMTL, CSS, and JavaScript. Possesses technical proficiency to debug, optimize functions, learn new platforms, and elevate user experience. I'm open to opportunities and hope to learn and collaborate with other developers and grow with a company.`}
						</p>
					</div>
